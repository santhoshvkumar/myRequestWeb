$(function() {
    ...
    init: function() {
        "use strict";
        altair_dashboard.peity_charts(), altair_dashboard.metrics_charts(), altair_dashboard.chartist_charts(), altair_dashboard.video_player(), altair_dashboard.clndr_calendar(), altair_dashboard.maplace_maps(), $window.load(function() {
    ...
    maplace_maps: function() {
        if ($("#map_users").length) {
            ...
            e.on("click", function(e) {
                ...
                var t = $(this),
                    a = t.index();
                t.addClass("md-list-item-active").siblings().removeClass("md-list-item-active"), google.maps.event.trigger(l.markers[a], "click")
            }), $(window).on("debouncedresize", function() {
                var e = l.oMap;
                google.maps.event.trigger(e, "resize"), e.fitBounds(l.oBounds)
            })
        }
    },
    peity_charts: function() {
        ...
        if (t.length) {
            ...
            /*$("#peity_live_text").text("0"), setInterval(function() {
                ...
                var s = new CountUp("peity_live_text", n, r, 0, 1.2);
                s.start()
            }, 2e3)*/
        }
    },
                 ...
                 $.get(domainAddress + "GetParticularAdminProblemSchedule/" + adminUserID, {}, function(resultProblemList) {
                        if (resultProblemList.record_count == 0) {
                            ...
                            for (Problem in resultProblemList.ProblemRecord) {
                                ...
                                newItem = {
                                            date: getStartDate,
                                            title: getProblemStatus,
                                            url: 'particularProblem.php', 
                                            timeStart: moment(getStartDate).format('DD.MM.YYYY'),
                                            timeEnd: moment(getEndDate).format('DD.MM.YYYY'),
                                        ...
                                        click: function(a) {
                                            ...
                                            if (a.events.length) {
                                                var i = $(".clndr_events"),
                                                    n = a.date._i;
                                                    problemID = a.events;
                                                    for (addproblemID in problemID) {
                                                        getProblemID = problemID[addproblemID].ProblemID;
                                                        console.log(getProblemID);
                                                        $(".dashbordProblemLink").addClass("titleClass");
                                                        
                                                    }
                                                    $(".titleClass").click(function(){
                                                        var eventTitleID = this.id.replace('eventTitleID-', '');
                                                        localStorage.setItem("ParticularProblemID", eventTitleID);
                                                        $(".dashbordProblemLink").attr("href", "particularProblem.php");
                                                    });
    ...
    video_player: function() {
        ...
        if (e.length) {
            ...
            t.on("click", "li", function(n) {
                ...
                var r = $(this);
                if (!r.hasClass(a)) {
                    var s = r.attr("data-video-src"),
                        l = '<iframe height="150" src="https://www.youtube.com/embed/' + s + '?rel=0" frameborder="0" allowfullscreen></iframe>';
                    t.children("li").removeClass(a), r.addClass(a), e.velocity({
                        translateZ: 0,
                        scale: 0,
                        opacity: 0
                    }, {
                        ...
                        complete: function() {
                            e.html(l), i(), setTimeout(function() {
                                e.velocity("reverse")
                            }, 280)
                        }
                    })
