      ...
      $.get(domainAddress + "getAdminDetails/" + adminUserID, function(result) {
          ...
          if (result.record_count == 0) {
              ...
              for (var getUserInfo in result.records) {
                  ...
                  if (result.records[getUserInfo].AdminTitle == null || result.records[getUserInfo].State == "null" || result.records[getUserInfo].AdminTitle == "") {
                  ...
                  if (result.records[getUserInfo].EmergencyGasNumber == "") {
                  ...
                  $("#inputAgencyCode").val(result.records[getUserInfo].AutoGenerate);
                  $(".inputPhoneNumber").css("padding", "10px 10px 10px 30px");
                  $(".phno-prefix").show();
                  $("#inputEmergencyNumber").css("padding", "10px 10px 10px 32px");
                  $("#inputEmergencyElectricityNumber").css("padding", "10px 10px 10px 32px");
  ...
  $(".btnUpdate").click(function() {
      ...
      var inputFirstName = $("#inputFirstName").val().replace(/["']/g, "`");
      var inputLastName = $("#inputLastName").val().replace(/["']/g, "`");
      var inputPhoneNumber = $("#inputPhoneNumber").val();
      var inputEmergencyNumber = $("#inputEmergencyNumber").val();
      var inputUrlRent = $("#inputUrlRent").val();
      var inputEmergencyElectricityNumber = $("#inputEmergencyElectricityNumber").val();
      ...
      var inputEmail = $("#inputEmail").val();
      var inputPassword = $("#inputPassword").val();
      var inputBusinessName = $("#inputBusinessName").val().replace(/["']/g, "`");
      var inputLocality = $("#inputLocality").val();
      var inputCity = $("#select2-inputCity-container").html();
      var inputState = $("#select2-inputState-container").html();
      var inputCountry = $("#inputCountry").val().replace(/["']/g, "`");
      var inputAgencyCode = $("#inputAgencyCode").val();
