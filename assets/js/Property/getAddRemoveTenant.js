function getAddTenant(count) {
    ...
    $(".inputMobile").keyup(function() {
        ...
        if (getMobileNumber == "") {
            ...
            $("#getErrorMsg-" + getCountValue).text("* Enter 10 digit Mobile Number.");
            $("#btnAddUserTenant-" + getCountValue).attr("disabled", true);
            return false;
        } else {
            $("#promno-prefix-"+getCountValue).show();
