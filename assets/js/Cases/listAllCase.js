            ...
            if (data.record_count == 0 || data.All_Records_Count == 0) {
                ...
                for (var Problem in data.ProblemRecord) {
                    ...
                    if (getMoment == "Invalid date")
                        ...
                        $(".ListAllProblem").append("<tr style='border-top: 2px solid #D9D9D9;' id='problemRow-" + data.ProblemRecord[Problem].ProblemID + "' class='all isAssignCheck-" + showStatus + "'> <td id='problemID-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign'style='vertical-align:middle;text-align:center;'> " + data.ProblemRecord[Problem].RequestID + "<br/><span class='momentBox'>(" + getMoment + ")</span></td><td id='problemImageID-" + data.ProblemRecord[Problem].ProblemID + "' class='problemImageSize' style='vertical-align:middle;'> <a class='problemImageLink'><span class='problemImage' id='problemImage-" + data.ProblemRecord[Problem].ProblemID + "'>   </span> </a></td>  <td id='problemSpecialityNameID-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign' style='vertical-align:middle'> <span class='speciality' id='speciality-" + data.ProblemRecord[Problem].ProblemID + "'>  </span> </td> <td  id='problemContractorNameID-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign'style='vertical-align:middle'> <span class='getContractor' id='contractor-" + data.ProblemRecord[Problem].ProblemID + "' name='" + ContractorID + "'> </span> </td> <td id='problemUserNameID-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign'style='vertical-align:middle'> <span class='userName' id='userName-" + data.ProblemRecord[Problem].ProblemID + "'>  </span> </td> <td id='problemEmailID-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign'style='vertical-align:middle'> <span id='emailID-" + data.ProblemRecord[Problem].ProblemID + "'>  </span> </td> <td id='problemPhoneNumber-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign'style='vertical-align:middle'> <span id='phoneNumber-" + data.ProblemRecord[Problem].ProblemID + "'>  </span> </td>   <td class='problemAlign' style='vertical-align:middle''><a class='linkColor problemStatusLink'><span class='problemStatus' id='statusID-" + data.ProblemRecord[Problem].ProblemID + "'>" + isAssign + "</span></a></td> <td id='getFixedAmount-" + problemID + "' style='display:none; vertical-align:middle; text-align: center;'> </td> <td id='getClosed-" + data.ProblemRecord[Problem].ProblemID + "' class='problemAlign' style='vertical-align:middle'> <button type='button' class='md-btn md-btn-primary isArchive' id='isArchive-" + data.ProblemRecord[Problem].ProblemID + "' data-on-label='Archive'>Close</button></td></tr>");
                        if (localProblemStatus == "Closed") {
                        ...
                        if (specialityName == null) {
                            ...
                            $("#speciality-" + problemID).append("<a class='linkColor specialityLink'>" + specialityName + "</a> ");
                        }
                        
                        if (name == null) {
                            $("#userName-" + problemID).html("No UserName Found");
                        } else if (name != null) {
                            $("#userName-" + problemID).append("<a class='linkColor userLink'>" + name);
                        }
                ...
                $(".speciality").click(function(){
                    var specialityID = this.id.replace('speciality-', '');
                    $(".specialityLink").attr("href", "particularProblem.php");
                    localStorage.setItem("ParticularProblemID", specialityID);
                });

                $(".userName").click(function(){
                    var userID = this.id.replace('userName-', '');
                    $(".userLink").attr("href", "particularProblem.php");
                    localStorage.setItem("ParticularProblemID", userID);
                });

                $(".problemImage").click(function(){
                    var ProblemImageID = this.id.replace('problemImage-', '');
                    $(".problemImageLink").attr("href", "particularProblem.php");
                    localStorage.setItem("ParticularProblemID", ProblemImageID);
                });

                $(".problemStatus").click(function(){
                    var StatusID = this.id.replace('statusID-', '');
                    $(".problemStatusLink").attr("href", "particularProblem.php");
                    localStorage.setItem("ParticularProblemID", StatusID);
                });
                                    ...
                                    if (resultProblemList.record_count == 0) {
                                        ...
                                        $('#calendar').fullCalendar({
                                            ...
                                            eventClick: function(calEvent, jsEvent, view) {
                                                ...
                                                window.location.href = "particularProblem.php";
                                                localStorage.setItem("ParticularProblemID", getCaseID);
                                            }
                                        });
                                    }
