            ...
            $(".contractorsApplied").show();
              ...
              $(".approveContractor").on('click',function(){
                ...
                UIkit.modal.confirm("Are you sure want to Approve ?", function(e) {
                  ...
                  var dataForm = '{"ProblemStatus":"' + problemStatus + '","ContractorID":"'+contractorID+'","ContractorName":"'+getContractorName+'","ProposalNotes":"'+proposalNotes+'","ProposalAmount":"'+proposalAmount+'","IsApproved":"1"}';
